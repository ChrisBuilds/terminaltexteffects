...
def get_effect_and_args() -> tuple[type[typing.Any], type[ArgsDataClass]]:
    return PourEffect, EffectConfig
...
class PourEffect:
    ...
    def build(self) -> None:
        ...
        }.get(self.config.pour_direction, PourDirection.DOWN)
    ...
    def __iter__(self) -> Iterator[str]:
        ...
        current_group = self._pending_groups.pop(0)
        gap = 0
        while self._pending_groups or self._active_characters or current_group:
