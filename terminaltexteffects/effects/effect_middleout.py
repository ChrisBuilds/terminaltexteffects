...
Example: effect_example""",
    ...
    effect_parser.add_argument(
        "--starting-color",  # make more descriptive
    ...
    effect_parser.add_argument(
        "--center-expand-color",  # make more descriptive
        type=argtypes.valid_color,
        default="00ff00",
        metavar="(XTerm [0-255] OR RGB Hex [000000-ffffff])",
        help="Color for the ___.",
    ...
    effect_parser.add_argument(
        "--full-expand-color",  # make more descriptive
        type=argtypes.valid_color,
        default="0000ff",
        metavar="(XTerm [0-255] OR RGB Hex [000000-ffffff])",
        help="Color for the ___.",
...
class MiddleoutEffect(base_effect.Effect):
    ...
    def __init__(self, terminal: Terminal, args: argparse.Namespace):
        ...
        self.final_gradient = graphics.Gradient(self.args.full_expand_color, self.args.final_color, 10)
    ...
    def prepare_data(self) -> None:
        ...
        for character in self.terminal.characters:
            ...
            for step in self.final_gradient:
                character.animation.add_effect_to_scene("final", character.input_symbol, step, 2)
        ...
        while self.pending_chars or self.animating_chars:
            if all([character.motion.active_waypoint == None for character in self.animating_chars]):
                ...
                for character in self.animating_chars:
                    character.motion.activate_waypoint("final")
