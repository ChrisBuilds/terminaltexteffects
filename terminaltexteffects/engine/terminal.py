...
class Canvas:
    ...
    ignoring terminal dimensions. Bounds are positive, inclusive, and immutable after
    construction. For even dimensions, center coordinates identify the lower central cell.
