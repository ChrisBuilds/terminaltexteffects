"""Exceptions for the terminaltexteffects package."""
...
class InvalidEventRegistrationEventCallerError(TerminalTextEffectsError):
    ...
    def __init__(
        ...
        """Initialize an InvalidEventRegistrationError.
...
class InvalidEventRegistrationActionTargetError(TerminalTextEffectsError):
    ...
    def __init__(
        ...
        """Initialize an InvalidEventRegistrationActionTargetError.
