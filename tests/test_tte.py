...
def test_pour_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
...
def test_scattered_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
    terminal = Terminal(input_data, False, animation_rate)
...
def test_expand_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
    terminal = Terminal(input_data, False, animation_rate)
...
def test_random_sequence_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
...
def test_spray_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
...
def test_rain_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
...
def test_shootingstar_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
    terminal = Terminal(input_data, False, animation_rate)
...
def test_rowslide_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
...
def test_verticalslice_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
    terminal = Terminal(input_data, False, animation_rate)
...
def test_rowmerge_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
    terminal = Terminal(input_data, False, animation_rate)
...
def test_burn_effect(input_data: str = BLOCK, animation_rate: int = 0) -> None:
    args = Namespace()
