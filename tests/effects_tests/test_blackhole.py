...
def test_blackhole_effect(input_data, terminal_config_default) -> None:
...
def test_blackhole_args(terminal_config_default, input_data, blackhole_color, star_colors) -> None:
    effect = effect_blackhole.Blackhole(input_data)
    effect.terminal_config = terminal_config_default
