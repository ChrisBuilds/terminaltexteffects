...
def test_slide_effect(input_data, terminal_config_default) -> None:
...
def test_slide_args(
    terminal_config_default, input_data, movement_speed, grouping, gap, reverse_direction, merge, easing_function_1
) -> None:
    effect = effect_slide.Slide(input_data)
    effect.terminal_config = terminal_config_default
