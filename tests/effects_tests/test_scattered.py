...
def test_scattered_effect(input_data, terminal_config_default) -> None:
...
def test_scattered_args(terminal_config_default, input_data, movement_speed, easing_function_1) -> None:
    effect = effect_scattered.Scattered(input_data)
    effect.terminal_config = terminal_config_default
