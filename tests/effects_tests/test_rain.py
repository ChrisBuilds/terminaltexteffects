...
def test_rain_effect(input_data, terminal_config_default) -> None:
...
def test_rain_args(
    terminal_config_default, input_data, rain_colors, movement_speed, rain_symbols, easing_function_1
) -> None:
    effect = effect_rain.Rain(input_data)
    effect.terminal_config = terminal_config_default
