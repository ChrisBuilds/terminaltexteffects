...
def test_spray_effect(input_data, terminal_config_default) -> None:
...
def test_spray_args(
    terminal_config_default, input_data, spray_position, spray_volume, movement_speed, easing_function_1
) -> None:
    effect = effect_spray.Spray(input_data)
    effect.terminal_config = terminal_config_default
