...
def test_binarypath_effect(input_data, terminal_config_default) -> None:
...
def test_binarypath_args(
    terminal_config_default, input_data, binary_colors, movement_speed, active_binary_groups
) -> None:
    effect = effect_binarypath.BinaryPath(input_data)
    effect.terminal_config = terminal_config_default
