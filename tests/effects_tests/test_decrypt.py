...
def test_decrypt_effect(input_data, terminal_config_default) -> None:
...
def test_decrypt_args(terminal_config_default, input_data, typing_speed, ciphertext_colors) -> None:
    effect = effect_decrypt.Decrypt(input_data)
    effect.terminal_config = terminal_config_default
