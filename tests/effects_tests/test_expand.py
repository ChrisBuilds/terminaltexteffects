...
def test_expand_effect(input_data, terminal_config_default_no_framerate) -> None:
...
def test_expand_args(terminal_config_default_no_framerate, input_data, movement_speed, easing_function_1) -> None:
    effect = effect_expand.Expand(input_data)
    effect.terminal_config = terminal_config_default_no_framerate
